...
public static class ReflectionUtils
{
    ...
    {
        [UsedImplicitly]
        internal bool HasAttribute<T>() where T : Attribute => type.GetCustomAttributes<T>().Any();
    ...
    {
        [UsedImplicitly]
        internal bool HasAttribute<T>() where T : Attribute => method.GetCustomAttributes<T>().Any();
